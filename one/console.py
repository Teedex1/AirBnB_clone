...
class HBNBCommand(cmd.Cmd):
    ...
    def do_show(self, line):
        ...
        '''
        # check if class name and instance id was providede
        if line == "" or line is None:
            print("** class name missing **")

        else:
            # get all the argument passed via the command line 
    ...
    def do_destroy(self, line):
        '''Usuage: 1. destroy < class name> <id> | 2. <class name>.delete(<id>)
    ...
    def do_all(self, line):
        '''Usuage: 1. all | 2. all <class name> | 3. <class name>.all(0
    ...
    def do_update(self, line):
        '''Usage: 1. updtae <class name> <id> <attribute> <value> | \
    ...
    def precmd(self, line):
        # make the app work non_interactively
        ...
        if checks:
            ...
            if args is None:
                ...
                if args_checks.group(2) is None:
                    ...
                    attribute_part = args_check.group(2)
